...
#include "WitchGraduate/Public/Projectile.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	WITCHGRADUATE_API UClass* Z_Construct_UClass_AProjectile_NoRegister();
	WITCHGRADUATE_API UClass* Z_Construct_UClass_AProjectile();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProjectile_OnHit, "OnHit" }, // 1967147179
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectile_Statics::NewProp_CollisionComponent_MetaData[] = {
		{ "Category", "Projectile" },
		{ "Comment", "// Sphere collision component. (From tutorial)\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Projectile.h" },
		{ "ToolTip", "Sphere collision component. (From tutorial)" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectile_Statics::NewProp_ProjectileMovementComponent_MetaData[] = {
		{ "Category", "Movement" },
		{ "Comment", "// Projectile movement component. (from tutorial)\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Projectile.h" },
		{ "ToolTip", "Projectile movement component. (from tutorial)" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectile_Statics::NewProp_ProjectileMeshComponent_MetaData[] = {
		{ "Category", "Projectile" },
		{ "Comment", "// Projectile mesh (from tutorial)\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Projectile.h" },
		{ "ToolTip", "Projectile mesh (from tutorial)" },
	};
#endif
	...
	IMPLEMENT_CLASS(AProjectile, 2320661559);
	template<> WITCHGRADUATE_API UClass* StaticClass<AProjectile>()
	{
		return AProjectile::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AProjectile(Z_Construct_UClass_AProjectile, &AProjectile::StaticClass, TEXT("/Script/WitchGraduate"), TEXT("AProjectile"), false, nullptr, nullptr, nullptr);
